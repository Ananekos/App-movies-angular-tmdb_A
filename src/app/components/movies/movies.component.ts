...
export class MoviesComponent implements OnInit {
  ...
  getMovies(){
      ...
      genre_id="";
        ...
        this.sortby_value='Popular Movies';
        let apiurl=myAppConfig.tmdb.movieBaseUrl+'/movie/popular?sort_by='+sort_by_desc+'&'+myAppConfig.tmdb.apikey+'&page='+page;
  ...
  getSearchContent(){
    ...
    Search_value=this.searchForm.value.movieName;
      if(Search_value){
        ...
        this.sortby_value='Popular Movies';
        this.country_value="";
        let  api_url=myAppConfig.tmdb.movieBaseUrl+'/movie/popular?sort_by='+sort_by_desc+'&'+myAppConfig.tmdb.apikey+'&page='+page;
